...
\begin{list2}
\item Recorded videos for \href{https://microcosm.web.cern.ch/en}{CERN Microcosm exhibit} in \faicon{sign-language} American Sign Language. One of the videos is on \href{https://www.youtube.com/watch?v=BaGjAruqFec}{\faicon{youtube}~YouTube}
...
\faicon{sign-language}~American Sign Language, English (bilingual), French Sign Language (elementary), British Sign Language (elementary), Italian Sign Language (elementary), Spanish (elementary), French (elementary)
