...
\begin{list2}
  ...
  \item Performing physics studies for gFEX. These studies include identifying subjets from trigger tower information, pileup mitigation techniques, and parameterizing trigger efficiency and rates for the online trigger objects I defined.
  ...
  \item Created and maintain an analysis framework for general physics analyses within ATLAS including Standard Model searches, SUSY, Exotics, Higgs, and Trigger-Level analysis: \href{https://xaodanahelpers.readthedocs.io/en/master/}{xAODAnaHelpers}
